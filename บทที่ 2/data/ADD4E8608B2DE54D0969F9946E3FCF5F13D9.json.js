        ...
        "data": {
            ...
            "commands": [
                ...
                },
                {
                    "id": "gs.Script",
                    "params": {
                        "script": "var cgNumber = GameManager.variableStore.tempNumbers[2] - 1;\nvar cg = RecordManager.cgGallery.first(function(cgItem) { return cgItem.slot-1 == cgNumber })\nvar unlocked = cg && GameManager.globalData.cgGallery[cg.index] && GameManager.globalData.cgGallery[cg.index].unlocked\nGameManager.variableStore.strings[0] = (cg && unlocked && cg.graphic) ? ResourceManager.getPath(cg.graphic) : \"\";"
                    },
                    "indent": 0,
                    "expanded": true,
